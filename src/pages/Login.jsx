  ...
  const loginWithGoogle = async () => {
    ...
    try {
      ...
      if (error.code !== "auth/popup-closed-by-user") {
        setLoginError("Sign-in failed. Check that pop-ups are allowed, then try again.");
      }
    } finally {
      setSigningIn(false);
    }
  ...
  return (
    <div className="page-shell login-page" style={{
      ...
      >
        ...
        >
          <button className="login-btn" onClick={loginWithGoogle} disabled={signingIn} aria-busy={signingIn}>
            {/* Google SVG */}
          ...
          {loginError && (
            <p role="alert" style={{ color: "#fca5a5", fontSize: "12px", lineHeight: 1.5, marginTop: "12px", textAlign: "center" }}>
              {loginError}
            </p>
          )}
